...
class PacketLength:
    ...
    def get_ip_length(self, packet_direction=None) -> list:
        """Creates a list of ip lengths.
        ...
        return (packet["IP"].len for packet, _ in self.feature.packets)

    def get_total_ip(self, packet_direction=None) -> int:
        """Calculates the summary ip lengths.

        Returns:
            packet_lengths (List[int]):

        """
        return sum(self.get_ip_length(packet_direction))

    def get_eth_length(self, packet_direction=None) -> list:
        """Creates a list of ip lengths.
        ...
        return (packet["Ether"].len for packet, _ in self.feature.packets)

    def get_total_eth(self, packet_direction=None) -> int:
        """Calculates the summary ip lengths.
        ...
        """
        return sum(self.get_eth_length(packet_direction))
