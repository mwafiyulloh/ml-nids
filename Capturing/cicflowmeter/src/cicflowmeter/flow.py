...
from .features.context import packet_flow_key, secondary_fields
...
from .utils import get_statistics, random_string


class Flow:
    """This class summarizes the values of the features of the network flows"""

    def __init__(self, packet: Any, direction: Enum, input_interface: Any, packet_number: int):
        ...
        (
            ...
            self.b64_data,
            self.mpls
        ) = secondary_fields.get_secondary_fields(packet, direction)
        self.iface = input_interface
        self.pkt_num = packet_number
        self._id = f'{random_string()}{random_string()}'
    ...
    def get_data(self) -> dict:
        ...
        data["mata_elang"] = {
                ...
                "ip_len": {"Forward": packet_length.get_total_ip(PacketDirection.FORWARD), 
                           "Backward": packet_length.get_total_ip(PacketDirection.REVERSE)},
                "msg": '', #snort 
                "priority": '', #snort
                "rule": '', #snort
                "rev": '', #snort
                ...
                "count": {'Forward': packet_count.get_total(PacketDirection.FORWARD),
                          'Backward': packet_count.get_total(PacketDirection.REVERSE),}, 
                "service": '', #snort
                "vlan": self.vlan,
                "class": '', #snort
                ...
                "ttl": self.ttl,
                "sensor_id": '', #snort
                "pkt_len": {"Forward": packet_length.get_total(PacketDirection.FORWARD),
                             "Backward": packet_length.get_total(PacketDirection.REVERSE)},
                "sid": '', #snort
                "eth_len": {"Forward": packet_length.get_total_eth(PacketDirection.FORWARD),
                            "Backward": packet_length.get_total_eth(PacketDirection.REVERSE)},                
                "gid": '', #snort
                "src_port": self.src_port,
