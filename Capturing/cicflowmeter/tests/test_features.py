...
def mock_flow(mock_packet):
    ...
    flow = Flow(tcp_packet, PacketDirection.FORWARD, 'wlp4s0')
    ...
    flow.add_packet(udp_packet, PacketDirection.FORWARD)
    flow.add_packet(udp_packet, PacketDirection.REVERSE)
    flow.add_packet(udp_packet, PacketDirection.FORWARD)
    flow.add_packet(udp_packet, PacketDirection.REVERSE)

    flow.add_packet(icmp_packet, PacketDirection.FORWARD)
    flow.add_packet(icmp_packet, PacketDirection.REVERSE)
    flow.add_packet(icmp_packet, PacketDirection.FORWARD)
    flow.add_packet(icmp_packet, PacketDirection.REVERSE)
